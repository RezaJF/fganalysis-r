...
duckdb -c "COPY (select * from read_csv('finngen_R13_hilmo_avohilmo_extended_1.0_dedup_fixbp.txt.gz',delim='\t', nullstr="NA") ) to 'finngen_R13_hilmo_avohilmo_extended_1.0_dedup_fixbp.txt.gz
' (FORMAT parquet)"
